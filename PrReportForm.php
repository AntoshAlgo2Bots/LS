...
$sql = "SELECT * FROM requisition_table_header a INNER JOIN requisition_table b ON a.header_id=b.s_no";
...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET["search_query"])) {
        ...
        $sql = "SELECT *
FROM requisition_table_header a
JOIN requisition_table b ON a.header_id = b.s_no
...
<body>
    ...
    <h1 class="text-4xl text-center font-bold underline mb-4">Purchase Requisition Report</h1>
