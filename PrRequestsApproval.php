...
$sql = "SELECT h.*, r.item_name, r.item_code, r.quantity, r.user_remarks, r.so_number 
FROM requisition_table_header h
JOIN requisition_table r
  ON h.header_id = r.header_id  WHERE h.status = 'inRunning'
...
<head>
    ...
    <title>Pr Request Approval</title>
</head>
...
<body class=" poppins-regular ">
    ...
    <div id="create_section" class="border bg-gray-100 border-gray-900 p-5 rounded-lg">
        <h1
            class="mb-2 text-4xl text-center font-bold leading-none tracking-tight text-gray-900 md:text-1xl dark:text-white">
            PR Requests Approval</h1>
                                            ...
                                            <tr class="hover:bg-gray-200 ">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                    <input type="txt" id="input-email-label"
                                                        class="py-3 px-2 block w-16 border-gray-200 bg-gray-50 bg-white text-center rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                        placeholder=1 value="<?php echo $i ?>" disabled>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                    <input type="txt" id="input-email-label"
                                                        class="py-3 px-4 block w-full border-gray-200 bg-gray-50 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                        placeholder=1 value="<?php echo $row['header_id'] ?>" disabled>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                    <input type="txt" id="input-email-label"
                                                        class="py-3 px-4 block w-full border-gray-200 bg-gray-50 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                    <input type="txt" id="input-email-label"
                                                        class="py-3 px-4 block w-full border-gray-200 bg-gray-50 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                        placeholder=1 value="<?php echo $row['item_name'] ?>" disabled>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                    <input type="txt" id="input-email-label" name="item_name"
                                                        class="py-3 px-4 block w-full border-gray-200 bg-gray-50 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                        placeholder="Item name" value="<?php echo $row['user_remarks'] ?>"
                                                        disabled>
                                                </td>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800"
                                                    ...
                                                    <input type="txt" id="input-email-label" name="Qty"
                                                        class="py-3 px-4 block w-full border-gray-200 bg-gray-50 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:
                                                inter-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                        ...
                                                        value="<?php echo $row['so_number'] ?>" disabled>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                    <input type="txt" id="input-email-label" name="total_price" disabled
                                                        class="py-3 px-4 block w-full border-gray-200 bg-gray-50 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                        value="<?php echo $row['department_name'] ?>" placeholder="Total">
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
            ...
            <div data-dialog-backdrop="dialog-lg" data-dialog-backdrop-close="true"
                ...
                <div data-dialog="dialog-lg"
                    ...
                    <div class="flex flex-wrap items-center justify-end p-4 shrink-0 text-blue-gray-500">
                        ...
                        <button data-ripple-light="true" data-dialog-close="true" onclick="submiDataConfirmToPr()"
        ...
        <div data-dialog-backdrop="dialog" data-dialog-backdrop-close="true"
            ...
            <div data-dialog="dialog"
                ...
                <div class="flex flex-wrap items-center justify-end p-4 shrink-0 text-blue-gray-500">
                    ...
                    <button data-ripple-light="true" data-dialog-close="true" onclick="submiDataRejectToPr()"
                        class="middle none center rounded-lg bg-gradient-to-tr from-green-600 to-green-400 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-green-500/20 transition-all hover:shadow-lg hover:shadow-green-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
                        Confirm
                    </button>
                </div>
    ...
    <script src="./js/prApproval.js"></script>
</body>
