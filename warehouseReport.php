...
$sql = "SELECT * FROM warehouse_deatails";
...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET["search_query"])) {
        ...
        $sql = "SELECT * FROM warehouse_deatails  where warehouse_id ='$query'or organization_name ='$query' or organaization_code ='$query' ";
...
<body>
    ...
    <h1 class="text-4xl text-center font-bold underline mb-4">Warehouse Report</h1>
                    ...
                    <table id="dataTable"
                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            <th scope="col" class="px-6 py-3">Record Number </th>
                                ...
                                <th scope="col" class="px-6 py-3">Organaization Name </th>
                                <th scope="col" class="px-6 py-3">Organaization Code</th>
                                <th scope="col" class="px-6 py-3">Location</th>
                                <th scope="col" class="px-6 py-3">Start_date</th>
                                <th scope="col" class="px-6 py-3">End_date
                                </th>
                                <th scope="col" class="px-6 py-3">GST Number</th>
                                <th scope="col" class="px-6 py-3">PAN Number</th>
                                
                                
                                <th scope="col" class="px-6 py-3">TAN Number </th>
                        ...
                        <tbody id="genDataTbody">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php echo $row['organaization_code'] ?>
                                    </td>
                                    <td class="px-6 py-4">
