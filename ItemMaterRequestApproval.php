...
<body class=" poppins-regular ">
    ...
    <div id="create_section" class="border bg-gray-100 border-gray-900 p-5 rounded-lg">
        <h1
            class="mb-2 text-xl text-center font-bold leading-none tracking-tight text-gray-900 md:text-1xl lg:text-3xl dark:text-white">
            Item Master Approval Form</h1>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr class="hover:bg-gray-200 ">
                                                ...
                                                <td class="px-2 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                    <input id="default-checkbox" item_code="<?php echo $row['item_code']; ?>" type="checkbox" value="" name="checkbox"
                                                        onchange="setLineTableToLine(event)"
                                                        P-id="<?php echo $row['S_No']; ?>"
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                    <input type="txt" id="input-email-label" name="s_no"
                                                        class="py-3 px-2 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                        placeholder=1 value="<?php echo $row['S_No'] ?>" disabled>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                    <input type="txt" id="input-email-label" name="item_category"
                                                        class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                        placeholder=1 value="<?php echo $row['Item_Category'] ?>" disabled>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                ...
                                                <!-- <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                    <input type="txt" id="input-email-label" name="total_price" disabled
                                                        class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                        value="<?php echo $row['sub_category'] ?>" placeholder="Total">
                                                </td> -->
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
    ...
    <script src="./js/itemApproval.js"></script>
</body>
