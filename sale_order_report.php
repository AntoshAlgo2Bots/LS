                    ...
                    <table id="dataTable"
                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            <th scope="col" class="px-6 py-3">SO Number </th>
                                ...
                                <th scope="col" class="px-6 py-3">installation_need_by_date</th>
                                <th scope="col" class="px-6 py-3">tntative_installation</th>


                                <th scope="col" class="px-6 py-3">perform_invoice </th>
                                <th scope="col" class="px-6 py-3">quotation_shared_date</th>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td class="px-6 py-4">
                                   ...
                                   <!-- // <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php echo $row['tntative_installation'] ?>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <?php echo $row['perform_invoice'] ?>
                                    </td>


                                    <td class="px-6 py-4">
                                        <?php echo $row['quotation_shared_date'] ?>
                                    </td>
