...
<head>
    ...
    <title>Gate Exit Creation Form</title>
...
<body>
    <div id="create_section" class="mt-5 bg-gray-100 border border-gray-900 p-5 rounded-lg mx-5">
        <h1 class="text-center underline text-3xl mb-3 font-bold">Gate Exit Creation Form</h1>
        <form class="w-full border border-gray-500 p-3 rounded-md" id="frmstore">
            ...
            <div class="flex flex-wrap mt-4 gap-x-20">
                ...
                <div>
                    ...
                    <input type="text" name="dispatched_by" required id="dispatched_by"
                        class="w-40 rounded-md border text-xs border-gray-500 bg-white pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                </div>
                <div>
                ...
                <div>
                    <label for="received_date"
                        class="block w-40 mb-2 font-bold text-xs font-medium text-gray-900">Dispatching Date & Time:</label>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#frmstore').submit(function (e) {
                ...
                $.post("action_gateExitCreate.php", frmData, function (response) {
...
$(document).ready(function () {
    $('#search').click(function (e) {
        ...
        $.post("action_gateExitCreate.php", { srch }, function (data) {
