            ...
            <tbody class="" id="rowAreaTbody">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-gray-900">
                        ...
                        <td class="px-6 py-4">
                            <input type="text" name="" id="" value=" <?php echo $row['from'] ?>" disabled>

                        </td>
                        <td class="px-6 py-4">
                            <input type="text" name="" id="" value=" <?php echo $row['to'] ?>" disabled>

                        </td>
                        <td class="px-6 py-4">
                            <input type="text" name="" id="" value=" <?php echo $row['startKm'] ?>" disabled>

                        </td>
                        <td class="px-6 py-4">
                            <input type="text" name="" id="" value=" <?php echo $row['endKm'] ?>" disabled>

                        </td>
                        <td class="px-6 py-4">
                            <input type="text" name="" id="" value=" <?php echo $row['totalKm'] ?>" disabled>

                        </td>
                        <td class="px-6 py-4">
                            <input type="text" name="" id="" value=" <?php echo $row['rate'] ?>" disabled>
