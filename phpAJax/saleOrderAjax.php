...
$query = "INSERT INTO `for_office`.`sale_order_header` (`username`, `user_address`, `user_phone_number`, `user_email`, `installation_is_required`, `installation_need_by_date`, `tntative_installation`, `perform_invoice`, `quotation_shared_date`, `remarks`,`created_by`,`created_date`,`lead_head_id`) 
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?);";
