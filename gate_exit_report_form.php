...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    if (isset($_GET["search_query"])) {
        ...
        $sql = "SELECT * FROM gate_exit_tbl  where s_no ='$query' or po_number='$query' or invoice_number='$query' ";
...
<head>
    ...
    <title>Get Exit Report</title>
</head>

<body>
    <section class="bg-gray-50 dark:bg-gray-900  mt-6   p-3 sm:p-5">
    <h1 class="text-4xl text-center font-bold underline mb-4">Gate Exit Report</h1>
