        ...
        <form class="w-full border border-gray-500 p-3 rounded-md" id="frmstore">
            <div class="w-full border border-gray-500 p-3 rounded-md">
                <div class="flex justify-between flex-wrap">
                    ...
                    <div>
                        ...
                        <input type="date" name="created_date" id="created_date" class="w-40 rounded-md border text-xs border-gray-500 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                    <div>
                        <label for="created_by" class="block w-36 mb-2 font-bold text-xs font-medium text-gray-900">Created By:</label>
                        <input type="text" name="created_by" id="created_by" class="w-40 rounded-md border text-xs border-gray-500 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-wrap m-2 gap-x-20">
                ...
                <div>
                    ...
                    <input type="text" name="invoice_number" id="invoice_number"  class="w-40 rounded-md border text-xs border-gray-500 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                </div>
                <div>
                    <label for="mode_of_transport" class="block w-40 mb-2 font-bold text-xs font-medium text-gray-900">Mode of Transport:</label>
                    <input type="text" name="mode_of_transport" id="mode_of_transport" class="w-40 rounded-md border text-xs border-gray-500 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                </div>
                <div>
                    <label for="vehicle_number" class="block w-40 mb-2 font-bold text-xs font-medium text-gray-900">Vehicle Number:</label>
                    <input type="text" name="vehicle_number" id="vehicle_number"  class="w-40 rounded-md border text-xs border-gray-500 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                </div>
                <div>
                    <label for="no_of_boxes" class="block w-40 mb-2 font-bold text-xs font-medium text-gray-900">No. Of Boxes:</label>
                    <input type="text"  name="no_of_boxes" id="no_of_boxes" class="w-40 rounded-md border text-xs border-gray-500 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                </div>
                <div>
                    <label for="weight" class="block w-40 mb-2 font-bold text-xs font-medium text-gray-900">Weight:</label>
                    <input type="text"  name="weight" id="weight" class="w-40 rounded-md border text-xs border-gray-500 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                </div>
            </div>
            ...
            <div class="flex flex-wrap m-2 gap-x-20 mt-5">
                <div>
                    ...
                    <input type="text" name="fireght_charges"  id="fireght_charges" class="w-40 rounded-md border text-xs border-gray-500 bg-white pl-2 text-[#6B7280] mb-5 h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                </div>
                <div>
                    <label for="recieved_by" class="block w-40 mb-2 font-bold text-xs font-medium text-gray-900">Received By:</label>
                    <input type="text" name="recieved_by"  id="recieved_by" class="w-40 rounded-md border text-xs border-gray-500 bg-white pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                </div>
                <div>
