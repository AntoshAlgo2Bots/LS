...
$sql = "SELECT item_code,sum(item_qty) as availeble_qty ,sum(hold_qty) as hold_qty,sum(item_qty)+sum(hold_qty) as total_qty,sub_inventory_name  FROM mtl_inventory_transactions inv group by item_code,sub_inventory_name ;
;";
$sql = "SELECT 
	item_code,
    sub_inventory_name,
